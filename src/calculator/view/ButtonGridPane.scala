...
class ButtonGridPane extends BorderPanel {
  ...
  val centerPane = new ButtonGridPane {
    ...
    val ansButton = createButton("ANS", 0, 4, 2)
    val bsButton = createButton("BS", 2, 4, 2)
    val clButton = createButton("CL", 4, 4, 2)
